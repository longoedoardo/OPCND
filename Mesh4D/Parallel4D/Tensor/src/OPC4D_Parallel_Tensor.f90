MODULE OPC4D_Parallel_Tensor_Module
...
CONTAINS
   ...
   SUBROUTINE OPC4D_Parallel_Tensor(ade, vertices_initial, vertices_final, facets, method, XYZT, W)
   ...
   END SUBROUTINE OPC4D_Parallel_Tensor

END MODULE OPC4D_Parallel_Tensor_Module