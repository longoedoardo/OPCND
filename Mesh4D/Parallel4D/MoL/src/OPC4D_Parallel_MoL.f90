MODULE OPC4D_Parallel_MoL_Module
...
CONTAINS
   ...
   SUBROUTINE OPC4D_Parallel_MoL(ade, n_tau, vertices_initial, vertices_final, facets, method, XYZT, W)
      ...
      !***********************************************************************
      !
      ! SUBROUTINE OPC4D_Parallel_MoL(ade, vertices, facets, method, XYZ, W)
      !
      ! Il seguente metodo e' parallelizzato con OpenMP
      !
   ...
   END SUBROUTINE OPC4D_Parallel_MoL

END MODULE OPC4D_Parallel_MoL_Module
