...
CALL OPC4D_Tensor(ade, vertices_initial, vertices_final, facets, 'GJCC', XYZT, W)
    ! CALL OPC4D_Tensor(ade, vertices_initial, vertices_final, facets, 'GJL', XYZT, W)
    ! CALL OPC4D_Tensor(ade, vertices_initial, vertices_final, facets, 'DCC', XYZT, W)
    ! CALL OPC4D_Tensor(ade, vertices_initial, vertices_final, facets, 'DGL', XYZT, W)
CALL CPU_TIME(t_end)
