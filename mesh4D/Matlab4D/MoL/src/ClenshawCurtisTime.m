...
% x_i = cos(i*pi/N)
%
% con i = 0,...,N, sull'intervallo [-1,1]. Se n_tau è il numero totale
% di nodi, allora il numero di sottointervalli è N = n_tau - 1.

num_intervalli = n_tau - 1;
theta = pi * (0:num_intervalli)' / num_intervalli;
nodiChebLob = cos(theta);

% Trasformazione affine da [-1,1] a [0,1]: x -> (x+1)/2.
