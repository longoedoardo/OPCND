...
**OptimalPolyCubatureND** è una libreria numerica progettata per il calcolo efficiente di regole di cubatura su domini poliedrici multidimensionali. Sviluppata in **MATLAB** e **Fortran**, la libreria offre implementazioni a basso costo computazionale ad alte prestazioni per problemi di integrazione.
